...
## Project Structure
    ...
    ├── tst_daniel_codegen__28559  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_codegen__28559`
...
2. Clone this repo and `cd tst_daniel_codegen__28559`
